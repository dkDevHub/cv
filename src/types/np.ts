...
export type NpGetSettlementsResponse = NpBaseResponse<NpGetSettlementsResponseData[]>;
export type NpGetWarehousesResponse = NpBaseResponse<NpGetWarehousesResponseData[]>;
